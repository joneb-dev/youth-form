    ...
    <>
      <Formik
        ...
        onSubmit={async (values) => {
          setSubmitting(true)
          await postData(`${process.env.REACT_APP_URL}/youth`, values);
          console.log("sucess");
          history.push("/sucess");
        }}
      >
          ...
          <div className={classes.paper}>
            <Form className={classes.form}>
              <Typography component="h1" variant="h3">
                Elevate Youth Registration
              </Typography>
              <p>
                Hey, Thanks for coming out to Elevate Youth Family! We're
                excited to have you. Please fill out this form so we can get you
                signed in. We hope you have an awesome time.
              </p>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  ...
                  >
                    <MenuItem
                      value={"Lighthouse Christian Fellowship"}
                      name="person.go_to_church"
                    >
                ...
                <Grid item xs={12}>
                  <InputLabel id="how-you-heard">
                    How did you hear about Elevate Youth Family?
                  </InputLabel>
                  <Field
